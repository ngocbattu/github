...
public class Dbhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String table_LoaiSach = "create table if not exists LoaiSach(MALOAI integer primary key , TENLOAI text , NHACUNGCAP text )";
        db.execSQL (table_LoaiSach);
        String INSERT_LOAISACH = "insert into LoaiSach values" +
                "(1, 'Tiểu thuyết','Nhà cung cấp 1'), " +
                "(2, 'Trinh Thám','Nhà cung cấp 2')," +
                "(3, 'Khoa học','Nhà cung cấp 3')," +
                "(4, 'Xã hội','Nhà cung cấp 4')," +
                "(5, 'Kinh dị','Nhà cung cấp 5')";
